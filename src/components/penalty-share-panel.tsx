...
export default function PenaltySharePanel({penaltyId,isPublic,username,title,groupName}:{penaltyId:string;isPublic:boolean;username:string;title:string;groupName:string}){
